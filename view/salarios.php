      ...
      <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="text-center" >
                <h3 style="font-size: 72px; font-family: initial; color: #fff">SALARIOS</h3>
            ...
            <form action="../controller/controller.php">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class=" panel-body">
                        OFICIO:<input class="form-control" type="text" name="oficio" maxlength="50" required="true">
                        SALARIO:<input class="form-control" type="text" name="salario" maxlength="50" required="true">
